  ...
  return (
    <div className="bg-lighten rounded p-3 flex flex-col" key={props.id}>
      ...
      <div className="flex mt-auto justify-between gap-2 pt-2">
        <a className="btn-primary basis-1/2 text-center" href={props.link} target="_blank">View Live</a>
        <a className="btn-secondary basis-1/2 text-center" href={props.repo} target="_blank">Repository</a>
      </div>
    </div>
  )
}
