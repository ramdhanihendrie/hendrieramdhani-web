        ...
        <!--<< Viewport Js >>-->
        <script src="{{ asset('build/assets/js/viewport.jquery.js') }}"></script>
        <!--<< Bootstrap Js >>-->
        <script src="{{ asset('build/assets/js/bootstrap.bundle.min.js') }}"></script>
        <!--<< Nice Select Js >>-->
        <script src="{{ asset('build/assets/js/jquery.nice-select.min.js') }}"></script>
        <!--<< Waypoints Js >>-->
        <script src="{{ asset('build/assets/js/jquery.waypoints.js') }}"></script>
        <!--<< Counterup Js >>-->
        ...
        <!--<< MeanMenu Js >>-->
        <script src="{{ asset('build/assets/js/jquery.meanmenu.min.js') }}"></script>
        <!--<< Magnific Popup Js >>-->
